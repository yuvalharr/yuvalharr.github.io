...
jsPsych.plugins["YH-wl-check-fps"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    //--------------------------------------
		...
		body.style.backgroundColor = 'ghostwhite'; // Should match canvas to prevent flickers
    ...
    canvas.style.right= '-9999px';
		...
		canvas.style.backgroundColor = 'ghostwhite'; // Should match body to prevent flickers
