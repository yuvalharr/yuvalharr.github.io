...
jsPsych.plugins['new-virtual-chin'] = (function() {

    var plugin = {};
  
    plugin.info = {
      name: "new-virtual-chin", 
      parameters: {
        viewing_distance_cm: {
        ...
        cardWidthPx: {    // ** need to take this later from previous resize trial --- YH **
            type: jsPsych.plugins.parameterType.INT,
          default: 500
        },
        pixels_per_unit: {
    ...
    function drawBall(pos=180){
        ...
        const cardWidthPx = trial.cardWidthPx;
      ...
      return degrees * Math.PI / 180;
        ...
        function show_stimulus(){
          display_element.innerHTML = `<p>Please use any credit card that you have available (it can also be a grocery store membership 
            ...
            html +='<button id="btnBlindSpot" class="btn btn-primary">Please click here to start the distance test</button></div></div>';
