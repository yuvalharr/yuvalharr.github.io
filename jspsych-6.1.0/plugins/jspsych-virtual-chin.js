    ...
    return degrees * Math.PI / 180;
      ...
      function show_stimulus(){
        display_element.innerHTML = `<p>Please use any credit card that you have available (it can also be a grocery store membership 
          card, your drivers license, or anything that is of the same format), hold it onto the screen, and adjust the slider below to exactly fit it's size.</p>`    
          ...
          html += "<p style='font-size: 1px;'>_</p>";
          html += "<p style='font-size: 1px;'>_</p>";
          html += "<p align='justify'>Please use any credit card that you have available (it can also be a grocery store membership card, your driver's license, or anything that is of the same format), hold it onto the screen, and adjust the slider below to exactly fit it's size.</p>";   
          html += "<p align='justify'>(If you don't have access to a real card, you can use a ruler to measure image width to 3.37 inch or 85.6mm)</p>";
          html += "<b style='font-style: italic'>Make sure you press the card against your screen.</b>";
          html += "<p style='font-size: 1px;'>_</p>";
          ...
          html += '<p align="left">2. Close your right eye. <em>(Tip: it might be easier to cover your right eye by hand!)</em></p>';
          html += '<p align="left">3. Using your left eye, focus on the black square.</p>';
          html += '<p align="left">4. Click on the button below to start the animation of the red ball. The <b style="color: red">red ball</b> will disappear as it moves from right to left. Press the Space key as soon as the ball disappears from your eye sight.</p><br>';
